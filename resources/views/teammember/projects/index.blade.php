                ...
                <div class="card h-100 shadow-sm project-card">
                    <div class="card-header pb-0">
                        <div class="d-flex justify-content-between align-items-start">
                            <div>
                                <h6 class="mb-0">
                                    <a href="{{ route('teammember.projects.show', $project) }}"
                    ...
                    <div class="card-body">
                        ...
                        <div class="mb-3">
                            <div class="d-flex justify-content-between align-items-center mb-1">
                                ...
                                <span class="text-sm fw-bold">{{ $project->my_tasks_progress_percentage }}%</span>
                            </div>
                            <div class="progress" style="height: 8px;">
                                <div class="progress-bar bg-gradient-success" role="progressbar"
                                    style="width: {{ $project->my_tasks_progress_percentage }}%"
                                    aria-valuenow="{{ $project->my_tasks_progress_percentage }}"></div>
                            </div>
                                ...
                                <div class="avatar-group">
                                    @foreach ($project->members->take(4) as $member)
                                        <a href="javascript:;" class="avatar avatar-xs rounded-circle"
                                            data-bs-toggle="tooltip" data-bs-placement="top" title="{{ $member->name }}">
                                    ...
                                    @if ($project->members->count() > 4)
                                        <a href="javascript:;" class="avatar avatar-xs rounded-circle"
                                            ...
                                            title="+{{ $project->members->count() - 4 }} lainnya">
                                            <div
