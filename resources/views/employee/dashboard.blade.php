            ...
            <div class="stat-card">
                <div class="stat-card-body">
                    <div class="stat-card-content">
                        <p class="stat-card-title">Tugas Dikerjakan</p>
                        <h4 class="stat-card-value">{{ $stats['in_progress'] }}</h4>
                    </div>
            ...
            <div class="stat-card">
                <div class="stat-card-body">
                    <div class="stat-card-content">
                        ...
                        <h4 class="stat-card-value">{{ $stats['pending'] }}</h4>
                    </div>
            ...
            <div class="stat-card">
                <div class="stat-card-body">
                    <div class="stat-card-content">
                        ...
                        <h4 class="stat-card-value">{{ $stats['revision'] }}</h4>
                    </div>
            ...
            <div class="stat-card">
                <div class="stat-card-body">
                    <div class="stat-card-content">
                        ...
                        <h4 class="stat-card-value">{{ $stats['completed'] }}</h4>
                    </div>
            ...
            <div class="col-xl-4 col-md-6 mb-4">
                <div class="card h-100 task-card">
                    <div class="card-body p-3 d-flex flex-column">
                        @php
                            // Logika untuk ikon dan warna berdasarkan nama proyek
                            $iconClass = 'fa-tasks';
                            $iconColor = 'bg-gradient-green';
                            $projectNameFirstWord = strtok($task->project->name, " ");
                            if (stripos($projectNameFirstWord, 'App') !== false) { $iconClass = 'fa-mobile-alt'; $iconColor = 'bg-gradient-danger'; }
                            elseif (stripos($projectNameFirstWord, 'Web') !== false) { $iconClass = 'fa-code'; $iconColor = 'bg-gradient-info'; }
                            elseif (stripos($projectNameFirstWord, 'Landing') !== false) { $iconClass = 'fa-file-alt'; $iconColor = 'bg-gradient-success'; }
                        @endphp
                        <div class="d-flex align-items-center mb-3">
                            ...
                            <div>
                                <h6 class="card-title fw-bold mb-0">
                                    {{-- PERBAIKAN: Link ke detail tugas --}}
                                    <a href="{{ route('employee.tasks.show', $task) }}" class="text-dark text-decoration-none">
                                        {{ $task->title }}
                                    </a>
                                </h6>
                                {{-- PERBAIKAN: Link ke detail proyek --}}
                                <p class="text-sm text-muted mb-0">
                                    <a href="{{ route('employee.projects.show', $task->project) }}" class="text-muted text-decoration-none">
                                        {{ $task->project->name }}
                                    </a>
                                </p>
                            </div>
                        ...
                        <div class="mt-auto">
                            ...
                            <div class="d-flex justify-content-between align-items-center mt-2">
                                ...
                                @php
                                    $progress = 0;
                                    // PERBAIKAN: Menggunakan strtolower untuk perbandingan case-insensitive
                                    // agar bisa menangani 'in_progress' dan 'In Progress' atau 'completed' dan 'Selesai'.
