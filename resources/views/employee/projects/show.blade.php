        ...
        <div class="card-header p-0 position-relative mt-n4 mx-3 z-index-2">
            <div class="bg-gradient-green shadow-dark border-radius-lg pt-4 pb-3">
                <div class="d-flex justify-content-between align-items-center px-3">
                    ...
                    <a href="{{ route('employee.projects.index') }}" class="btn btn-outline-light btn-sm mb-0">
                                        ...
                                        <div class="d-flex px-3 py-1">
                                            <div class="d-flex flex-column justify-content-center">
                                                <h6 class="mb-0 text-sm">
                                                    <a href="{{ route('employee.tasks.show', $task->id) }}" class="text-dark fw-bold text-decoration-none">{{ $task->title }}</a>
                                                </h6>
