                    ...
                    <div class="bg-gradient-green shadow-dark border-radius-lg pt-4 pb-3">
                        <div class="d-flex justify-content-between align-items-center px-3">
                            ...
                            <div class="d-flex gap-2">
                                ...
                                <div class="dropdown">
                                    <button class="btn btn-light btn-sm dropdown-toggle mb-0" type="button" data-bs-toggle="dropdown" aria-expanded="false">
                                        <i class="fas fa-filter me-1"></i> Filter
                                    </button>
                                    <ul class="dropdown-menu dropdown-menu-end">
                                        <li><h6 class="dropdown-header">Status</h6></li>
                                        <li><a class="dropdown-item" href="{{ route('pm.reports.index') }}">Semua</a></li>
                                        <li><a class="dropdown-item" href="{{ route('pm.reports.index', ['status' => 'Menunggu Persetujuan']) }}">Menunggu Persetujuan</a></li>
                                        <li><a class="dropdown-item" href="{{ route('pm.reports.index', ['status' => 'Disetujui']) }}">Disetujui</a></li>
                                        <li><a class="dropdown-item" href="{{ route('pm.reports.index', ['status' => 'Ditolak']) }}">Ditolak</a></li>
                            ...
                            <table class="table align-items-center mb-0">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <div class="d-flex px-2 py-1">
                                                ...
                                                <div class="d-flex flex-column justify-content-center">
                                                    <h6 class="mb-0 text-sm">{{ $report->title ?? Str::limit($report->content, 50) }}</h6>
                                        ...
                                        {{-- Kolom Tipe --}}
                                        <td>
                                            <p class="text-xs font-weight-bold mb-0 text-capitalize">{{ $report->type }}</p>
                                        </td>
                                        ...
                                        {{-- Kolom Aksi --}}
                                        <td class="align-middle text-center">
                                            <a href="{{ route('pm.reports.show', $report) }}" class="text-info font-weight-bold text-xs" data-toggle="tooltip" title="Lihat Laporan">
                                                Lihat
                                            </a>
                                            @if($report->status === 'Menunggu Persetujuan')
                                            <a href="{{ route('pm.reports.edit', $report) }}" class="text-secondary font-weight-bold text-xs mx-3" data-toggle="tooltip" title="Edit Laporan">
                                                Edit
                                            </a>
                                            <a href="javascript:;" class="text-danger font-weight-bold text-xs" data-bs-toggle="modal" data-bs-target="#deleteReportModal-{{ $report->id }}" title="Hapus Laporan">
                                                Hapus
                                            </a>
                                            @endif
                                        </td>
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-center py-4">
                ...
                <p>Anda yakin ingin menghapus laporan: <br><strong>"{{ $report->title ?? Str::limit($report->content, 50) }}"</strong>?</p>
            </div>
